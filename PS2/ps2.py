...
#
# Answer:
# Each node represents a building. An edge is the connection between each building/node
# The weighted edge values are the actual distance between the two buildings and
# the distance outdoors between both buildings.
